...
LIB = cdll.LoadLibrary('/Users/fraccaman/Projects/BlockchainBar/src/store/iblt/libpyblt.so')
...
PYBLT.set_parameter_filename(
    '/Users/fraccaman/Projects/BlockchainBar/src/store/iblt/param.export.0.995833.2018-07-17.csv')
